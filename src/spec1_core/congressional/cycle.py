...
Usage:
    python -m spec1_core.congressional.cycle            # live mode
    python -m spec1_core.congressional.cycle --sample  # built-in sample data
"""
...
from spec1_core.congressional.collector import fetch_trades, SAMPLE_TRADES
from spec1_core.congressional.parser import parse_batch
from spec1_core.congressional.scorer import score_signal, clear_novelty_cache
from spec1_core.congressional.analyzer import analyze
